...
const page = () => {
  return (
    <article className="">
      <div className="border-b-[0.1px] border-stone-900 px-[32px] py-[64px] md:px-[48px] md:py-[160px]">
        ...
        <span className="block font-mono text-center font-light text-xs md:text-sm opacity-70 ">
          <time datetime="2024-02-27">Feb 27, 2024</time> •{" "}
          <address className="inline"></address> • 25 min read
        </span>
      </div>
      <div className="gap-4 md:text-lg xl:grid xl:grid-cols-[1fr_48rem_1fr]">
        ...
        <div className="p-12 xl:border-l-[0.1px] xl:border-r-[0.1px] border-stone-900 mx-auto max-w-[75ch] font-light text-left">
          {/* headings */}
          <h4
          ...
          {/* Bullet points */}
          <ul className="c list-disc ounter-reset-[list-counter] mb-6">
