  ...
  return (
    <div className="gap-[1/-1]">
      <div className="flex flex-col items-center justify-center md:h-[calc(100vh-200px)] max-w-full p-8 md:p-12 mx-auto w-[815px]">
        <h1 className="flex flex-col md:space-y-3 font-semibold text-center text-3xl md:text-6xl">
          We are a blockchain engineering and research consulting firm
        ...
        <p className="mt-6 text-center text-md md:text-lg font-light opacity-60">
